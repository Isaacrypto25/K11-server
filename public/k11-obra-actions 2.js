...
const OBRA = {
    ...
    actions: {
        ...
        async carregarProjetos() {
            ...
            // Só re-renderiza a tela se o usuário já estiver em obraHome —
            // isso evita que um carregamento em segundo plano (ex: no boot
            // do app, via OBRA.init()) sequestre a navegação e force a
            // home para "Minhas Obras" quando deveria ser outra tela.
            if (APP._currentView === 'obraHome') APP.view('obraHome');
            try {
