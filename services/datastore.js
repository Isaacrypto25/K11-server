...
const _instance = new DataStore();
// A instância já expõe this.supabase diretamente.
// Compatibilidade: const { supabase } = require('./services/datastore')
// retorna a propriedade .supabase da instância.
